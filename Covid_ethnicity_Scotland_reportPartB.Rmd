...
Where there is evidence of an elevated risk of "severe test positive disease" or "severe test positive or death" among those of South Asian ethnicity in Part A of this report, the observed rate ratios are slightly higher among those of Indian ethnicity compared to those of Pakistani/Bangladeshi using the disaggregated SMR approach.  For those with Black ethnicity in Part A of the report, the disaggregated data show that those classed as Black Caribbean have an increased risk of "severe test positive disease" and "severe test positive or death", as do Black Africans, but numbers are very small in these groups and therefore estimates are more unstable.

When applying the disaggregated ONOMAP approach, we see that those with Muslim South Asian ethnicity are at an increased risk of "severe test positive disease" or "severe test positive or death" and not those classed as Other South Asian ethnicity.
...
rownames(table.hospitalized.demogB7) <- gsub("_", " ", rownames(table.hospitalized.demogB7))
knitr::kable(table.hospitalized.demogB7,
             escape=FALSE, 
             booktabs=TRUE,
             label="onomap.hosp",
             col.names=c(clean.header(colnames(table.hospitalized.demogB7)[1:2]),
                         "Rate ratio (95\\% CI)", "p-value",
                         "Rate ratio (95\\% CI)", "p-value"),
             align=rep("c", 6), 
...
```{r onomapB7, echo=FALSE, warning=FALSE, message=FALSE}

rownames(table.severe.demogB7) <- gsub("_", " ", rownames(table.severe.demogB7))
knitr::kable(table.severe.demogB7,
             escape=FALSE, 
             booktabs=TRUE,
             label="onomapB7",
             col.names=c(clean.header(colnames(table.severe.demogB7)[1:2]),
                         "Rate ratio (95\\% CI)", "p-value",
                         "Rate ratio (95\\% CI)", "p-value"),
             align=rep("c", 6),
...
```{r onomapNRSB7, echo=FALSE, warning=FALSE, message=FALSE}

rownames(table.severe.demogNRSB7) <- gsub("_", " ", rownames(table.severe.demogNRSB7))
knitr::kable(table.severe.demogNRSB7,
             escape=FALSE, 
             booktabs=TRUE,
             label="onomapNRSB7",
             col.names=c(clean.header(colnames(table.severe.demogNRSB7)[1:2]),
                         "Rate ratio (95\\% CI)", "p-value",
                         "Rate ratio (95\\% CI)", "p-value"),
             align=rep("c", 6),
             caption="Associations of severe disease OR any COVID-19 death with demographic variables including ethnicity based on name classification") %>%
