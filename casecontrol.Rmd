...
Identifiable data were extracted by the Public Health Scotland CHI database and linkage team and de-identified before provision to the analysis team.
...
p.incidence
dev.off()
tiff("Figure2.tiff", res=300, width=2100, height=1800)
p.wdists
dev.off()
tiff("Figure3.tiff", res=300, width=2100, height=1800)
p.roc
dev.off()
}
