...
knitr::kable(table.demog.append[, 1:5],
    ...
    kableExtra::group_rows("Ethnicity based on name classification", 1, 3, bold=FALSE) %>%
    kableExtra::group_rows("SIMD quintile", 4, 8, bold=FALSE) %>%
    kableExtra::group_rows("Ethnicity based on Scottish Morbidity Record", 10, 13, bold=FALSE,
...
knitr::kable(table.agegr.all[-4, ],
    ...
    # kableExtra::group_rows(" ", 4, nrow(table.agegr.all[-4, ])) %>%
...
#   kableExtra::group_rows(" ", 4, nrow(tables.agegr[[1]]) - 1) %>%
    column_spec(column=1, width="4cm") %>%
...
knitr::kable(tables.agegr[[2]][-4, ],
 ...
 #   kableExtra::group_rows(" ", 4, nrow(tables.agegr[[2]]) - 1) %>%
    column_spec(column=1, width="4cm") %>%
    column_spec(column=2:7, width="2.7cm") %>%
   add_header_above(c(" "=3, "Univariate"=2, "Multivariate"=2)) %>%
    landscape() %>%
...
#    kableExtra::group_rows(" ", 4, nrow(tables.agegr[[3]]) - 1) %>%
    column_spec(column=1, width="4cm") %>%
   column_spec(column=2:7, width="2.7cm") %>%
    add_header_above(c(" "=3, "Univariate"=2, "Multivariate"=2)) %>%
    landscape() %>%
