...
*Findings* -- In those without a diagnosis of a listed condition, severe COVID-19 was strongly associated with polypharmacy, defined by total number of drug classes dispensed: with those who had no dispensed prescriptions as reference group, the rate ratio (95% CIs) for COVID-19 associated with dispensing of 12 or more drug classes was XX.  In those with listed conditions, this association was in the reverse direction: the corresponding rate ratio was XX.  The regression coefficients for number of cardiovascular drug classes and number of other drug classes in a joint model were XX and XX respectively; thus the association with polypharmacy was specifically with non-cardiovascular drugs.  A backwards elimination procedure identified proton pump inhibitors, and analgesics (both opiates and non-opiate / compound preparations) as the drug classes with the largest independent contribution to the association of COVID-19 with polypharmacy.  Further analysis of the association with proton pump inhibitors showed a dose-response relationship with the average daily dose dispensed, that the association remained that the association was strongest in younger age groups: the rate ratio for COVID-19 associated with ever-use of a proton pump inhibitor varied from `r table.everuse.protonpump[3, 3]` in those aged 75 years and over to `r table.everuse.protonpump[1, 3]` in those aged under 60 years.  
