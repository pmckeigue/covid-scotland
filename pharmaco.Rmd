...
_Methods_ -- In the REACT-SCOT case-control study, ten controls were matched for sex, age and general practice to each of the 4320 cases of severe COVID-19 in Scotland since the start of the epidemic.  Cases and controls were linked to records of hospital discharges in the last three years and dispensed prescriptions issued in primary care since June 2019.  
...
knitr::kable(table.dosegr,
    ...
    kableExtra::group_rows(group_label="Proton pump inhibitors (defined daily doses / day)", 9, 16) %>%
...
colnames(table.timewindow.protonpump) <- colnames(table.timewindow.opiate)
...
knitr::kable(table.timewindow,
             ...
             booktabs=TRUE,
             row.names=FALSE, 
             col.names=c("Time window", clean.header(colnames(table.timewindow.opiate)[1:2]), 
                         "Rate ratio (95\\% CI)", "$p$-value"),
    ...
    kable_styling(latex_options="hold_position") %>%
    kableExtra::group_rows(group_label="Opiate-containing analgesics", 1, 4) %>%
