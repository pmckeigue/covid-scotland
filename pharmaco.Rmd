...
knitr::kable(table.numdrugsgr,
    ...
    column_spec(column=1, width="2cm") %>%
    kableExtra::group_rows("Age 0-59", 1, 6) %>%
    kableExtra::group_rows("Age 60-74", 7, 12) %>%
    kableExtra::group_rows("Age 75+", 13, 18) %>%
    kableExtra::group_rows("No admissions", 19, 24, hline_before=TRUE, latex_gap_space="12pt") %>% 
    kableExtra::group_rows("1 to 2 ICD-10 chapters in hospital diagnoses", 25, 30) %>%
    kableExtra::group_rows("3 or more ICD-10 chapters in hospital diagnoses", 31, 36) %>%
    kable_styling(latex_options="hold_position")
}
...
knitr::kable(table.numdrugsgr.num.icdch,
             ...
             col.names=c("Number of drug classes", colnames(table.numdrugsgr.num.icdch)[2:3],  
                         "Rate ratio (95\\% CI)", "$p$-value"),
             caption="Association of severe COVID-19 with polypharmacy in those without listed conditions, by number of ICD-10 chapters represented in hospital diagnoses") %>%
    column_spec(column=1, width="2cm") %>%
    kableExtra::group_rows("No admissions", 1, 6) %>%
    kableExtra::group_rows("1 to 2 ICD-10 chapters in hospital diagnoses", 7, 12) %>%
    kableExtra::group_rows("3 or more ICD-10 chapters in hospital diagnoses", 13, 18) %>%
    kable_styling(latex_options="hold_position")
```
