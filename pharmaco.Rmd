...
knitr::kable(table.numdrugsgr.listed.any,
    ...
    group_rows(paste0("No listed condition (",
                      freqs[1, 1], " controls, ", freqs[1, 2], " cases)"),
               1, 6) %>%
    group_rows(paste0("Listed condition (",
