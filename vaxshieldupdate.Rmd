...
# Results
## Time course of the epidemic and associations with risk factors 
Fig \ref{fig:plotcases} shows the daily numbers of severe cases (averaged over 3-day sliding windows) by risk category.  From mid-January to early March 2021 there was a rapid decline in the incidence of severe cases, followed by a slight increase from early June to early July.  

Fig \ref{fig:plotrateratios} shows the time course of rate ratios (computed over 42-day sliding windows) for risk category, vaccination dose (coded as 0, 1, 2 doses), and recent (5 to 14 days before presentation date) hospital exposure as inpatient.  These rate ratios are computed from a model that includes all variables shown, together with care home residence. 

The rate ratio for severe disease associated with shielding eligibility did not decline as the winter peak declined, and increased from May 2020 onwards.  The efficacy of vaccination against severe disease (modelled as the rate ratio per 2 doses) remained high, despite the rapid replacement of the Alpha by the Delta variant during May 2020.   
...
knitr::kable(table.shieldgr[14:21, ], 
             escape=FALSE, 
             booktabs=TRUE,
...
knitr::kable(table.hosp.shieldgr[13:20, ], 
             escape=FALSE, 
             booktabs=TRUE,
